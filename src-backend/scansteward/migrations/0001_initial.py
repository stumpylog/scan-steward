    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text=(
                            "The image is in the trash and needs to be deleted from the file system on scheduled run"
                        ),
                    ),
                ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                check=models.Q(("day_valid", False), models.Q(("month_valid", False), _negated=True), _connector="OR"),
