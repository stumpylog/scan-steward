    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "album",
                    models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to="scansteward.album"),
                ),
                (
                    "image",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "applied",
                    models.BooleanField(default=False, help_text="This tag is applied to this image"),
                ),
                (
                    "image",
                    models.ForeignKey(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                through="scansteward.TagOnImage",
                to="scansteward.tag",
            ),
        ),
        migrations.CreateModel(
