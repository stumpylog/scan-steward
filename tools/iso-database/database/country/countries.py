...
ALPHA2_CODE_TO_COUNTRIES: Final[dict[str, Country]] = {
    ...
    "BO": Country("BO", "Bolivia, Plurinational State of"),
    ...
    "IR": Country("IR", "Iran, Islamic Republic of"),
    "IQ": Country("IQ", "Iraq"),
    ...
    "KR": Country("KR", "Korea, Republic of"),
    "KW": Country("KW", "Kuwait"),
    "LA": Country("LA", "Lao People's Democratic Republic"),
    ...
    "MD": Country("MD", "Moldova, Republic of"),
    ...
    "KP": Country("KP", "Korea, Democratic People's Republic of"),
    ...
    "SY": Country("SY", "Syrian Arab Republic"),
    ...
    "TW": Country("TW", "Taiwan, Province of China"),
    "TZ": Country("TZ", "Tanzania, United Republic of"),
    ...
    "VE": Country("VE", "Venezuela, Bolivarian Republic of"),
    "VG": Country("VG", "Virgin Islands, British"),
    "VI": Country("VI", "Virgin Islands, U.S."),
    "VN": Country("VN", "Viet Nam"),
